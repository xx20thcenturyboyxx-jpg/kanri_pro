...
@media print { 
    ...
    /* ガラス道具用（そのままの大きさでOK） */
    .print-glass table { font-size: 12pt; margin-top: 10px; }
        ...
        if print_mode:
            ...
            if category == "ガラス道具":
                ...
                <div id="print-area" class="print-glass">
                    <h3>{category} 現在庫一覧 <span style="font-size: 12pt; font-weight: normal; margin-left: 20px;">{today_str}</span></h3>
                    {html_table}
                </div>
                """
